    ...
    <footer className="footer py-10 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 border-b border-gray-700 pb-8 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">
              Desenvolvimento de sistemas e aplicativos de alta qualidade para impulsionar o seu negócio.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#home" className="text-gray-400 hover:text-white transition duration-150">Início</a></li>
              <li><a href="#about" className="text-gray-400 hover:text-white transition duration-150">Sobre</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#services" className="text-gray-400 hover:text-white transition duration-150">Desenvolvimento Web</a></li>
              <li><a href="#services" className="text-gray-400 hover:text-white transition duration-150">Aplicativos Mobile</a></li>
              <li><a href="#services" className="text-gray-400 hover:text-white transition duration-150">Consultoria</a></li>
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-primary">Fale Conosco</h4>
            <p className="text-gray-400 mb-2">Email: vinicioscampera@vincdev.com</p>
        ...
        <div className="text-center text-sm text-gray-500">
          &copy; {new Date().getFullYear()} VinCDEV. Todos os direitos reservados.
        </div>
      </div>
    </footer>
  );
